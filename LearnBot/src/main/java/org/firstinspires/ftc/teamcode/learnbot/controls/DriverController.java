package org.firstinspires.ftc.teamcode.learnbot.controls;
...
import org.firstinspires.ftc.teamcode.learnbot.Setup.Connected;
import org.firstinspires.ftc.teamcode.learnbot.components.Launcher;
...
public class DriverController implements Loggable {
    ...
    public void bindDriveControls() {
        if (Connected.DRIVEBASE) {
            ...
            turboButton.whenPressed(PedroDrivebase.Commands.TurboSpeed());
            normalButton.whenPressed(PedroDrivebase.Commands.NormalSpeed());
            snailButton.whenPressed(PedroDrivebase.Commands.SnailSpeed());
