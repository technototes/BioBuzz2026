...
public class Turretonlytele extends CommandOpMode {
    ...
    public void runLoop() {
        ...
        if (robot.follower != null) {
            panelsTelemetry
                .getTelemetry()
                .addData("robotX", String.valueOf(robot.follower.pose().x()));
            panelsTelemetry
                .getTelemetry()
                .addData("robotY", String.valueOf(robot.follower.pose().y()));
            panelsTelemetry
                .getTelemetry()
                .addData(
                    "robotHeadingDeg",
                    String.valueOf(Math.toDegrees(robot.follower.pose().heading()))
                );
        }
    }
}
