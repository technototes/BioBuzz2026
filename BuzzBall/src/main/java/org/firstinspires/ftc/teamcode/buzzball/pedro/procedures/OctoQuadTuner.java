...
public class OctoQuadTuner extends Procedure {
    ...
    public void run() throws InterruptedException {
        ...
        Inputs.Field<PodType> podType = inputs
            .e("Odometry Pod Type", PodType.class)
            .withDefault(PodType.FOUR_BAR);
        Inputs.Field<OctoQuad.I2cRecoveryMode> recoveryMode = inputs
        ...
        Inputs inputsHeadingScalar = inputs(
        ...
        double headingScalar = runOpMode(
        ...
        code(
            ...
            "public static OctoQuadConfig localizerConfig = new OctoQuadConfig(c -> {\n" +
                ...
                (podType.get() == PodType.CUSTOM
                    ...
                    : "    c.ticksPerUnit.set(" +
                      (podType.get() == PodType.SWING_ARM ? SWING_ARM : FOUR_BAR) +
                      ");\n") +
                "    c.xPodOffset.set(" +
                offsets.get(0) +
                ");\n" +
